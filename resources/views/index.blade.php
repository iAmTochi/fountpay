                            ...
                            <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                <div class="product product-style-3 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('product.single', $product->id) }}" title="{{ $product->name }}">
                                            <figure><img src="{{ asset('front') }}/assets/images/products/digital_20.jpg" alt="{{ $product->name }}"></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="#" class="product-name"><span>{{ $product->name }}</span></a>
                                        <div class="wrap-price"><span class="product-price">${{ number_format($product->price, 2) }}</span></div>
                                        <a href="{{ route('cart.rapid.add', $product->id) }}" class="btn add-to-cart">Add To Cart</a>
                                    </div>
                                </div>
                            </li>
                            @endforeach
