                            ...
                            <div class="product-gallery">
                                <ul class="slides">
                                    ...
                                    <li data-thumb="assets/images/products/digital_18.jpg">
                                        <img src="{{ asset('front') }}/assets/images/products/digital_18.jpg" alt="product thumbnail" />
                                    </li>

                                    <li data-thumb="assets/images/products/digital_17.jpg">
                                        <img src="{{ asset('front') }}/assets/images/products/digital_17.jpg" alt="product thumbnail" />
                                    </li>

                                    <li data-thumb="assets/images/products/digital_15.jpg">
                                        <img src="{{ asset('front') }}/assets/images/products/digital_15.jpg" alt="product thumbnail" />
                                    </li>

                                    <li data-thumb="assets/images/products/digital_02.jpg">
                                        <img src="{{ asset('front') }}/assets/images/products/digital_02.jpg" alt="product thumbnail" />
                                    </li>

                                    <li data-thumb="assets/images/products/digital_08.jpg">
                                        <img src="{{ asset('front') }}/assets/images/products/digital_08.jpg" alt="product thumbnail" />
                                    </li>

                                    <li data-thumb="assets/images/products/digital_10.jpg">
                                        <img src="{{ asset('front') }}/assets/images/products/digital_10.jpg" alt="product thumbnail" />
                                    </li>

                                    <li data-thumb="assets/images/products/digital_12.jpg">
                                        <img src="{{ asset('front') }}/assets/images/products/digital_12.jpg" alt="product thumbnail" />
                                    </li>

                                    <li data-thumb="assets/images/products/digital_14.jpg">
                                        <img src="{{ asset('front') }}/assets/images/products/digital_14.jpg" alt="product thumbnail" />
                                    </li>
                                            ...
                                            <ol class="commentlist">
                                                <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                    <div id="comment-20" class="comment_container">
                                                        <img alt="" src="{{ asset('front') }}/assets/images/author-avata.jpg" height="80" width="80">
